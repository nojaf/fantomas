...
type CodeFormatter =
    ...
    static member FormatDocumentAsync : fileName: string * source: SourceOrigin * config: FormatConfig -> Async<string>
    ...
    static member FormatSelectionAsync :
        fileName: string * selection: Range * source: SourceOrigin * config: FormatConfig -> Async<string>
